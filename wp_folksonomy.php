...
define('WP_FOLKSONOMY_VERSION','0.21');
...
function wp_folksonomy_get_options(){
	...
	if (!isset($options['version'])){
		...
		$default_array=array('user'=>'all','approve'=>'immediate','version'=>WP_FOLKSONOMY_VERSION,'javascript'=>'js');
...
function wp_folksonomy_subpanel(){
	...
	<p>You currently have <?php echo $tag_count;?> user contributed tags on your website.</p>
	</div>
	<?php
